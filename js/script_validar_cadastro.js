...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        //NOMEMAE-------------
         id('nomemae').setAttribute('maxlength', 60);
...
const validateNomemae = (event) => {
    ...
    if(!nomemaeTest || input.value.length < 15 ) { 
        ...
        id('span_nomemae').style.display='block';
        id('nomemae').classList.add('error_input');
        id('span_nomemae').innerHTML="Nome com menos de 15 caractéres.";
    } else {
        nomemae_valido = true; 
        id('span_nomemae').style.display='none';
        id('nomemae').classList.remove('error_input');   
    }
}
